                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <span class="account-user-avatar">
                                <img src="{{ (!empty($profileData->image)) ? url($profileData->image) : url('upload/no_image.jpg') }}" alt="user-image" width="32" class="rounded-circle">
                            </span>
                            <span class="d-lg-flex flex-column gap-1 d-none">
                                <h5 class="my-0">{{ $profileData->name }}</h5>
                                <h6 class="my-0 fw-normal">
                                    {{ $profileData->usertype == 0 ? 'Admin' : $profileData->usertype }}
                                </h6>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                            ...
                            <!-- item-->
                            <a href="{{ route('profile_change') }}" class="dropdown-item">
